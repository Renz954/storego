   ...
   <body class="dashboard dashboard_1">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="full">
            ...
            <div style="background: url('http://172.16.161.100/storego/StoregoAllocationV2/assets/images/logo/ENGINEERING.png') no-repeat ; background-size: contain;height: 251px; margin-top: -85px; margin-bottom: -206px; padding-bottom: 53px; margin-left: 67px;">
