   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                      ...
                      <li class="homepage-menu">
                          <a onclick="bookkeeper_home_js()" style="cursor: pointer"><i class="fa fa-dashboard yellow_color"></i> <span>Home</span></a>
                      </li>

                      <!-- <li class="agency_menu">
                          <a onclick="book_agency_js()" class="dynamic-style" style="cursor: pointer">🗃️ <span>AGENCY</span></a>
                      </li> -->

                      <li class="agency_menu">
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">🗃️ <span>AGENCY</span></a>
                        <ul class="collapse list-unstyled" id="element">
                           <li class="agency_record_menu"><a onclick="book_agency_record_js()" style="cursor: pointer">📰 <span>Record</span></a></li>
                           <li class="agency_report_menu"><a onclick="book_agency_report_js()" style="cursor: pointer">📊 <span>Report</span></a></li>
                        </ul>
                     </li>

                      <li class="nav_allo_menu">
                          <a onclick="book_nav_allo_js()" style="cursor: pointer">📚 <span>Navision Allocation Basis</span></a>
                      </li>

                      <li class="go_exp_menu">
                          <a onclick="book_go_exp_js()" style="cursor: pointer">💵 <span>Store GO Expense</span></a>
                      </li>

                      <li class="agency_exp_menu">
                          <a onclick="book_agency_exp_js()" style="cursor: pointer">🤑 <span>Agency Expense</span></a>
                      </li>

                      <li class="report_menu">
                          <a onclick="book_report_js()" style="cursor: pointer">📁 <span>Report</span></a>
                      </li>

                      <li class="code_setup_menu">
                          <a onclick="book_code_setup_js()" style="cursor: pointer">🧩 <span>Account Code Setup</span></a>
                      </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="full">
            ...
            <div style="background: url('http://172.16.161.100/storego/StoregoAllocationV2/assets/images/logo/BOOKKEEPER.png') no-repeat ; background-size: contain;height: 251px; margin-top: -85px; margin-bottom: -206px; padding-bottom: 53px; margin-left: 67px;">
