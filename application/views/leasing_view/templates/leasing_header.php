   ...
   <body class="dashboard dashboard_1">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="full">
            ...
            <div style="background: url('assets/images/logo/leasing_testing.png') no-repeat ; background-size: contain;height: 274px; margin-top: -93px; margin-bottom: -206px; padding-bottom: 53px; margin-left: 67px;">
