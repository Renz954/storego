   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                      ...
                      <li class="homepage-menu">
                          <a onclick="hrd_home_js()" style="cursor: pointer"><i class="fa fa-dashboard yellow_color"></i> <span>Home</span></a>
                      </li>

                      <li class="records-menu">
                          <a onclick="records_js()" class="dynamic-style" style="cursor: pointer"><i class="fa fa-user orange_color"></i> <span>Records</span></a>
                      </li>
                      <li class="reports-menu">
                          <a onclick="reports_js()" style="cursor: pointer"><i class="fa fa-table purple_color2"></i> <span>Reports</span></a>
                      </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="full">
            ...
            <div style="background: url('http://172.16.161.100/storego/StoregoAllocationV2/assets/images/logo/HRD.png') no-repeat ; background-size: contain;height: 274px; margin-top: -93px; margin-bottom: -206px; padding-bottom: 53px; margin-left: 67px;">
