               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                      ...
                      <li class="homepage-menu">
                          <a onclick="ssd_home_js()" style="cursor: pointer"><i class="fa fa-dashboard yellow_color"></i> <span>Home</span></a>
                      </li>

                      <li class="records-menu">
                          <a onclick="ssd_record_js()" class="dynamic-style" style="cursor: pointer">📁 <span>SSD Record</span></a>
                      </li>

                      <li class="reports-menu">
                          <a onclick="ssd_report_js()" class="dynamic-style" style="cursor: pointer">📊 <span>SSD Reports</span></a>
                      </li>
