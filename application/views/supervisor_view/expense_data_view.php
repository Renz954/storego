...
<div class="form-inline">
        <div class="form-group mr-3">
         <label class="mr-2"><strong>Select Year&nbsp;</strong></label>
           <select name="desig" id="year_id" class="form-control mr-2" onchange="select_exp_data_js()">
      ...
      <div class="form-group mr-3">
        <input id="les_rec_id" type="text" class="form-control"  value ="" style="display: none;">
          <label class="mr-2"><strong>Select Month &nbsp;</strong></label>
            <select name="desig" id="month_id" class="form-control mr-2" onchange="select_exp_data_js()">
                <option value="" readonly>Select</option>
                    <?php
       ...
       <div class="form-group mr-3">
           <label class="mr-2"><strong>Select Store&nbsp;</strong></label> 
                <select name="store_id" id="store_id" class="form-control mr-2" onchange="select_exp_data_js()">
                     <option value="" readonly>Select</option>
                         <?php
      ...
      <div class="form-group mr-3">
         <label class="mr-2"><strong>Status&nbsp;</strong></label>
            <select  id="status_exp_id" class="form-control mr-2" onchange="select_exp_data_js()" >
                       <?php 
      ...
      <span hidden id="select_all"></span>
            <div class="table-responsive" id="table_expense_store_data" >
            </div>
