...
<div class="form-inline">
      ...
      <select name="desig" id="year_id" class="form-control mr-2" onchange="select_finance_report_js()">
      <option value="" readonly>Select</option>
       ...
       <div class="form-group mr-3">
                ...
                <label><strong>Select Month&nbsp;</strong></label>
                   <select name="desig" id="month_id" class="form-control mr-2" onchange="select_finance_report_js()">
                    <option value="" readonly>Select</option>
                    <?php
                        for($a=1;$a<13;$a++)
                        {
        ...
        <div class="form-group mr-3">
            <select id="alloTypeFilter" class="form-control mr-2">
        ...
        <div class="form-group mr-3">
            ...
            <select name="store_ids" id="store_ids" class="form-control mr-2" onchange="select_finance_report_js()"> 
                <?php
