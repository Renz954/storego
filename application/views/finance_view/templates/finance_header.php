   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                    ...
                    <div class="user_profle_side">
                        <div style="background-image: url('http://172.16.161.100/storego/StoregoAllocationV2/assets/images/logo/store_go_logo.png'); background-repeat: no-repeat; background-size: contain; width: 200px; height: 200px; margin-top: -71px; margin-bottom: -62px; z-index: -999;"></div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="full">
            ...
            <div style="background: url('http://172.16.161.100/storego/StoregoAllocationV2/assets/images/logo/FINANCE.png') no-repeat ; background-size: contain;height: 251px; margin-top: -85px; margin-bottom: -206px; padding-bottom: 53px; margin-left: 67px;position: relative;">
