...
<div class="form-inline">
              <div class="form-group mr-3">
                  <label class="mr-2"><strong>Select Year</strong></label>
                      <select name="desig" id="year_id" class="form-control mr-2" onchange="select_monitor_allo_js()">
                        <?php 
                            $year=date("Y");
           ...
           <div class="form-group mr-3">
                 <label class="mr-2"><strong>Select Month</strong></label>
                     <select name="desig" id="month_id" class="form-control mr-2" onchange="select_monitor_allo_js()">
 ...
 <hr class="custom-hr">
     ...
     <div class="table-responsive" id="table_monitor_nav">

    </div>

<script type="text/javascript">
  select_monitor_allo_js();
</script>