...
<div class="form-inline" >
               ...
               <div class="form-group mr-3">
                 ...
                 <div class="form-group mr-3">
                    ...
                    <select name="store_id" id="store_id" class="form-control mr-2" onchange="select_nav_data_js()"> 
                        <!-- <option value="" readonly>Select</option> -->
                        <?php
                        // $get_store_name = $this->Finance_Model->setup_store_model($_SESSION['id']);
                        $get_all_bu = $this->Finance_Model->get_all_bu_model();
                        foreach($get_all_bu as $bu)
                         {           
                                // $get_bu = $this->Finance_Model->get_bu_id_model_v2($name['bu_handle']);
            ...
            <div class="table-responsive" id="table_fin_nav_data">
            </div>
